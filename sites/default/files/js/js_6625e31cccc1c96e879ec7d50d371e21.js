...
;
 ...
 $('.view-clientes-home .view-content').before('<div id="prev">Anterior</div>').after('<div id="next">Proximo</div>').cycle({ fx: 'fade', next: '#next', prev: '#prev' });
 });;
